...
TITLE_KEYWORD_HINTS = {
    ...
    # AUDIT ADDITION: full-dataset title-frequency check showed the original
    # hint list covered 100% of the 12 non-technical "filler" titles but 0%
    # of any technical title (Software Engineer, Cloud Engineer, ML Engineer,
    # etc.) — a real blind spot affecting 19% of confirmed honeypots (12/63),
    # which had a technical title our strongest mismatch detector couldn't
    # check at all. Investigated adding generic titles like "Software
    # Engineer" but found their real descriptions span QA/DevOps/frontend/
    # mobile too legitimately to build a reliable hint list (any generic
    # "engineering"/"code" hint would barely discriminate). ML/AI-specific
    # titles, by contrast, were verified to consistently use distinctive
    # ML vocabulary in their real descriptions — added these as they're
    # both reliably checkable AND the titles closest to the actual JD
    # target role.
    "ml engineer": ["model", "machine learning", "training", "inference", "dataset", "neural", " ml "],
    "junior ml engineer": ["model", "machine learning", "training", "inference", "dataset", "neural", " ml "],
    "ai research engineer": ["model", "machine learning", "research", "neural", "training", "paper", "experiment"],
    "data engineer": ["pipeline", "etl", "data", "spark", "airflow", "warehouse", "kafka"],
    "senior data engineer": ["pipeline", "etl", "data", "spark", "airflow", "warehouse", "kafka"],
    "analytics engineer": ["analytics", "dbt", "warehouse", "sql", "dashboard", "metrics"],
}
